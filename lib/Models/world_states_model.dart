...
class WorldStatesModel {
  ...
  factory WorldStatesModel.fromMap(Map<String, dynamic> map) {
    return WorldStatesModel(
      ...
      recoveredPerOneMillion: map['recoveredPerOneMillion'].toDouble() as double,
